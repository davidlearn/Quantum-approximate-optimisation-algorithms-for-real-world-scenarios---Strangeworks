...
In addition, we describe ways to optimize QAOA with appropriate initilizations of ($\boldsymbol{\beta}$, $\boldsymbol{\gamma}$) and <strong>p</strong> values with the current NISQ computers with limitted qubits and quantun circuits.
